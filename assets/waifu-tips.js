...
function add() {
    ...
    if(text.length>0){
    $.ajax({
        url: "http://openapi.tuling123.com/openapi/api/v2/chat",//接口地址
        type: "post",
        dataType: "json",
        data: {
...
$('.waifu-tool .fui-info-circle').click(function (){
    ...
    window.open('https://store.steampowered.com/app/616720/Live2DViewerEX');
});
